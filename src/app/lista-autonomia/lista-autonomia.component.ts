...
@Component({
  selector: 'app-lista-autonomia',
  templateUrl: './lista-autonomia.component.html',
  styleUrls: ['./lista-autonomia.component.css']
})
export class ListaAutonomiaComponent implements OnInit {
  ...
  verAutonomia(row) {
    this.router.navigate(['ver-autonomia', row]);
  }

  renderDataTable() {
    this.enviadaservice.getDataAutonomias()
      .subscribe(
        x => {
